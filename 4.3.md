...
<b>This URI is both CDATA-enclosed and the & is XML-encoded. The player will interpret the URI as: http://ad.server.com/impression/dot.gif?v=1&amp;id=1234 </b>
...
```
<b>Not enclosed in a CDATA section even though > is encoded </b>
...
- Static image file
- Any static resource file where the media player handles the click, such as when “playerHandles=true” in a VPAID AdClickThru event. NonLinearClickThrough is only available for InLine ads. 
...
|/Creative |/NonLinearAds |   | Yes | 3.12 |
|/NonLinearAds |/NonLinear|  |  | 3.12.1 |
|/NonLinear |/NonLinearClickTracking |  |   | 3.12.2 |
